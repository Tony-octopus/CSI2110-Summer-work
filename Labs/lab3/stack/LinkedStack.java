...
public class LinkedStack<E> implements Stack<E> {
  ...
  public void push(E element) {
    ...
    //if stack empty, becomes head w no next node
    if (this.isEmpty()){
      Node<E> thing = new Node(element, null);
      this.head = thing;
    } else {  //else, prev head is next of newly pushed thing
      Node<E> thing = new Node(element, head);
      this.head = thing;
    }
  ...
  public E pop() {
    ...
    //else, temp var to hold head, cut tie to head, head.next (should point to the element below)
    else{
